...
<!-- <div id="map" style="width:100%;height:350px;"></div> -->
	...
	<div class="container" align="center">
		...
		<form action="insertAction" method="post" enctype="multipart/form-data">
			...
			<table class="table table-striped"  border="1" height="600">
				 <tr>
					<td width=150>작성자</td>
					<%-- <td><input type="text" name="mem_id" required="required" readonly value="${sessionScope.id}"></td> --%>
					<td>${mem_id}${lat}${lng}</td>
				</tr> 
				<tr>
				<th width="150">위치 선택하기</th>
				<td>
...
//	$("#lng").val(lng);
	/* self.close();} */
			...
			<input type="button" value="위치 확인" onclick="myson('${mem_id}')"/>	
				...
				<tr>
					<td>제목</td>
					<td><input type="text" size=60 name="lost_title" required="required"></td>
				</tr>
				<tr>
					<td>비밀번호</td>
					<td><input type="password" size=60 name="lost_pwd" required="required"></td>
				</tr> 
				
				<tr>
					<td>내용</td>
					<td><textarea rows="8" cols="58" name="lost_content"
