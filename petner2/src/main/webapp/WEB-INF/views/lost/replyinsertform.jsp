 ...
 <div id="bbswrite_wrap">
  ...
  <form method="post" action="<%=request.getContextPath() %>/replyLostInsertOk" onSubmit="return board_check()">
   ...
   <div id="bbswrite_menu">
    <input type="submit" class="btn btn-outline-secondary" value="등록" class="input_button" />
    <input type="reset" class="btn btn-outline-secondary" value="취소" class="input_button"
