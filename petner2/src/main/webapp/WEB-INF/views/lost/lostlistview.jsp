...
<body>
	<div class="container" align="center">
		...
		<table class="mytable" width=1000>
			<tr height=50>
				<th width=120>번호</th>
				<th width=480>제목</th>
				<th>작성자</th>
			...
			<c:if test="${empty list}">
				<tr>
					<td colspan="5" height=50>데이터가 없습니다</td>
				</tr>
			</c:if>
				...
				<c:forEach var="lost" items="${list}">
					<tr height=50>
						...
						<c:if test="${lost.lost_del =='y'}">
							<td colspan="4" style="text-align: left">여러분의 관심덕분에 아이를 찾았습니다 감사합니다.</td>
						</c:if>
						 <c:if test="${lost.lost_del !='y' }">	<!-- ${path}를 사용할 수 없다면 제거 -->
							<td style="text-align: left"><a href="${path}/lostView?lost_no=${lost.lost_no}&pageNum=${pp.currentPage}"    
	...
	<!-- 	<ul class="pagination"> -->
		...
		<br>
		<div align="center">
			<input type="button" class="btn btn-outline-secondary" value="글 작성" onClick="location.href='lostInsertForm'"/>
		</div>
	</div>
	<br>
	</div>
