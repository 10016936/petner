	 ...
	 <div class="container" align="center"> 
		...
		<form action="insertAction" method="post" enctype="multipart/form-data">
			...
			<table class="mytable" align=center width=600 height=600>
				...
				<tr>
				<th width=100 height=50%>위치 선택하기</th>
...
//	$("#lng").val(lng);
	/* self.close(); */
			...
			<input type="button" value="위치 확인" onclick="myson('${mem_id}')"/>	
				...
				<tr>
					<th>제목</th>
					<td><input type="text" size=59 name="lost_title" required="required"></td>
				</tr>
				<tr>
					<th>비밀번호</th>
					<td><input type="password" size=59 name="lost_pwd" required="required"></td>
				</tr> 
				
				<tr>
					<th height=23%>내용</th>
					<td><textarea rows="8" cols="57" name="lost_content"
