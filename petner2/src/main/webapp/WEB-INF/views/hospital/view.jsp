...
<body>
	<div>
		...
		<table class=mytable align=center width=1000 height=650>
			<tr colspan=3 align=center>
				<th rowspan=8 width="50%">
				<c:if test="${empty hospital.hospital_file}">&nbsp; </c:if>
		...
		<div align="center">
			<c:if test="${sessionScope.mem_id == 'admin'}">
				...
				<input type="button" value="목록" class="btn btn-outline-secondary" onClick="location.href='hospital_list?page=${page}'">
		</div>
		<br><br>
