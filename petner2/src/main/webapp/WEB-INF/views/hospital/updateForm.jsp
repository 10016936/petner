...
<body>
	<form action="hospital_update" method="post" name="form" onSubmit="return check()"
		...
		<table class=mytable align=center width=600 height=650>
			...
			<tr>
				<th width=250>병원명</th>
				<td><input type="text" size=60 id="hospital_name" name="hospital_name" value="${hospital.hospital_name}"></td>
			</tr>
   			<tr>
				<th>비밀번호</th>
				<td><input type="password" size=60 id="hospital_pwd" name="hospital_pwd"
					autofocus="autofocus">
			</tr>
			<tr>
				<th>지역</th>
			...
			<tr>
				<th>우편번호</th>
				<td><input type=text size=44 id="hospital_post" name="hospital_post" value="${hospital.hospital_post}">
					<input type=button value="우편번호 검색"
					onClick="openDaumPostcode()" class="click"></td>
			<tr>
				<th>주소</th>
				<td><input type=text size=60 id="hospital_addr"
					name="hospital_addr" value="${hospital.hospital_addr}"></td>
			</tr>
			<tr>
				<th>전화번호</th>
				<td><input type=text size=60 id="hospital_tel"
			...
			<tr>
				<th height=20%>소개</th>
				<td><textarea rows="7" cols="58" id="hospital_content"
				name="hospital_content">${hospital.hospital_content}</textarea></td>
			</tr>
			<tr>
				<th>링크</th>
				<td><input type="text" size=60 id="hospital_link" name="hospital_link" value="${hospital.hospital_link}"></td>
			</tr>
			<tr>
				<th>이미지</th>
