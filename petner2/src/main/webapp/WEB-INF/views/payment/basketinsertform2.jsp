...
//			alert('${payment_no1}');			
	 ...
	 .payment{
	  ...
	  <form action="basketinsertstart1" method="post" id="form7485" name="myform"> 
	 <div class="payment">
	 ...
	 <br><br><br>
	 주문 가격 :  총주문금액은<fmt:formatNumber pattern="###,###,###" value = "${totalprice}"/> 원입니다
	 <br><br><br>
	...
	<c:if test="${transferpoint == null }">
	 ...
	 <br><br><br>
	 <input type="text" id=usemem_point name=usemem_point value="${member.mem_point}"  > <input type="button" id="button1" name="button1" value="적립금 사용" onclick="point('${member.mem_point}')">
	 ...
	 <br><br><br>
	<input type="checkbox" id="check" name="check" onclick="check1()" checked="checked"> 상기의 내용을 모두 확인했고 결제를 진행합니다.
