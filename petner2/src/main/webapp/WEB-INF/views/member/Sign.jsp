...
<body>
	...
	<table class=mytable align=center width=600 height=550>
		...
		<tr>
		<th>이름</th>
		<td><input type="text" name="mem_name" id="mem_name" class="mem"/><td>
		</tr>
		<tr>
		<th>비밀번호</th>
		<td><input type="password" name="mem_pwd" id="mem_pwd" class="mem"/><td>
		</tr>
		<tr>
		<th>비밀번호 확인</th>
		...
		<input type="text" name="mem_phone2" id="mem_phone2"/>-<input type="text" name="mem_phone3" id="mem_phone3"/><td>
		</tr>
		<tr>
		<th>성별</th>
		<td><input type="radio" name="mem_gender" id="mem_gender1" value="male"/>남자
		<input type="radio" name="mem_gender" id="mem_gender2" value="female"/>여자</td>
		</tr>
		<tr>
		<th>우편번호</th>
		<td><input type="text" name="mem_post" id="mem_post" readonly>
		<input type="button" value="우편번호검색" onClick="openDaumPostcode()"/><td>
		</tr>
		<tr>
		<th>주소</th>
		<td><input type="text" name="mem_addr1" id="mem_addr1" class="mem" readonly/><td>
		</tr>
		<tr>
		<th>상세주소</th>
		<td><input type="text" name="mem_addr2" id="mem_addr2" class="mem"/><td>
		</tr>
		<tr>
		<th>생일</th>
		<td><input type="text" name="mem_birth" id="datepicker"/><td>
		...
		<tr>
		<th>이메일</th>
		<td><input type="text" name="mem_email" id="mem_email"/>@<input type="text" name="mem_domain" id="mem_domain"/>
		...
		<input type="reset" value="취소" id="sign_up"/>
		</div>
	</form>
