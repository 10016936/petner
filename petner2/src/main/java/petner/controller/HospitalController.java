...
public class HospitalController {
	...
	public String hlist(String page, Hospital hospital, Model model) throws Exception {
		...
		List<Hospital> hlist = hs.list(hospital);
	...
	public String view(int hospital_no, int page, String state,
		...
		String admin_id = (String) session.getAttribute("mem_id");
